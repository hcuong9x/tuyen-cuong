...
var renderCanvas1 = function () {
  ...
  background.src = "/tuyen-cuong/templates/" + invitationInfo.templateID + "/bg1.png";
  background.onload = function () {
    ...
    ctx.fillStyle = "#BF7864";

    canvas.style.letterSpacing = "15px";
    ctx.font = "40px 'Jura', cursive";
    ctx.fillText("HAPPY WEDDING", canvas.width / 2, 200);
    ctx.save();

    canvas.style.letterSpacing = "0";
    ctx = canvas.getContext("2d");
    ctx.font = "300px 'Jura', cursive";
    ctx.textBaseline = "middle";
    ctx.textAlign = "center";
    ctx.fillText(
      invitationInfo.groom_name_one + invitationInfo.bride_name_one,
      canvas.width / 2 + 10,
      1080
    );
    ctx.save();
...
var renderCanvas2 = function () {
  ...
  canvas.height = canvasHeight;
  var background = new Image();
  background.src = "/tuyen-cuong/templates/" + invitationInfo.templateID + "/bg2.png";
  background.onload = function () {
    canvas.width = this.width;
    canvas.height = this.height;
    ctx.drawImage(this, 0, 0, this.width, this.height);
    ...
    ctx.fillStyle = "#BF7864";
    ctx = canvas.getContext("2d");
    ctx.font = "90px 'dancing_scriptregular', cursive";
    ctx.textBaseline = "middle";
    ctx.textAlign = "center";
    ctx.fillText(
      invitationInfo.groom_name_short +
    ...
    canvasTxt1.drawText(
      ...
      canvas.width / 2 - canvasTxt0Width / 2 + 20,
      1700,
      canvasTxt0Width,
      200
    );
